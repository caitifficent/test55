...
namespace Etier.IconHelper
{
	...
	public class IconListManager
	{
        ...
        public int AddFileIcon(string filePath, bool foldere)
        {
            ...
            if (foldere == true)
            {
                ...
                else
                {
                    ...
                    if (ManageBothSizes == true)
                    {
                        ...
                        ((ImageList)_imageLists[0]).Images.Add(ExtractIcon.GetIcon(filePath, true));
                    ...
                    else
                    {
                        ...
                        ((ImageList)_imageLists[0]).Images.Add(ExtractIcon.GetIcon(filePath, true));	//add to image list
                    }
            ...
            else
            {
                ...
                extension = ((string)splitPath.GetValue(splitPath.GetUpperBound(0))).ToUpper();

                if (extension == "EXE" || extension == "ICO" || extension == "ICN" || extension == "LNK")
                {
                    int nonHashedIconPos = ((ImageList)_imageLists[0]).Images.Count;
                    // store current count -- new item's index

                    ((ImageList)_imageLists[0]).Images.Add(ExtractIcon.GetIcon(filePath, true)); //add to image list
                    return nonHashedIconPos;
                }
